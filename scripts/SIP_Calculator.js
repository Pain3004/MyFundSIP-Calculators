'use strict';
    ...
    let futureValue,
        ...
        function calculateIt() {
            ...
            catchInvested.innerHTML = "Rs. " + Math.round(futureValue);
            catchTotalInvested.innerHTML = "Rs. " + Math.round(invested);
            catchEstReturns.innerHTML = "Rs. " + Math.round(returnedValue);
            // console.log('VALUES :', futureValue, invested, returnedValue)
