'use strict';
    ...
    let futureValue,
        ...
        catchTotalInvested = document.getElementById("TotalInvested"),
        catchEstReturns = document.getElementById("EstReturns"),
        returnedValue;
        ...
        function calculateIt() {
            ...
            var totalreturns = A - TotalInvested;
            ...
            catchInvested.innerHTML = "Rs. " + Math.round(A);
            catchTotalInvested.innerHTML = "Rs. " + Math.round(TotalInvested);
            catchEstReturns.innerHTML = "Rs. " + Math.round(totalreturns);
